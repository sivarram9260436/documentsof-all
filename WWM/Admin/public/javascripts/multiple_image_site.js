        ...
        if (li && file) {
            ...
            xhr.onreadystatechange=function(){
                 if (xhr.readyState==4 && xhr.status==200){
                      var create_list_image = '<li class="image_update_list">"'+xhr.responseText+'"</li>' 
					opener.$('#add_imageset_list').after(create_list_image);
					}
					}
            xhr.open(
                "POST",
               "site_popup_image_manager_step1?"+pars
            );
