...
function start() {
	...
	jQuery("#parent_" + tinyid + " fieldset").append('<legend></legend>');
	jQuery("#parent_" + tinyid + " fieldset legend").html("Page_" + maxId);
	...
	jQuery("#parent_" + tinyid + " .tiny_subcontaner .inactive_tiny_holder").append('<div class="text_holder"></div>');
	jQuery("#parent_" + tinyid + " .tiny_subcontaner .inactive_tiny_holder").append('<input type="button" value="Expand" style="color:#92B2D6;font-size:1.2em;float:right;" onclick=expand("' + tinyid + '") />');
