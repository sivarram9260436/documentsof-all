     ...
     if(options.sort==true){
        ...
        //  $('#'+elemid).removeAttr('name');
         ...
         stop:function(event,ui){
           var sortable_array = [];
          $(this).find('li').not('#'+ul_li_input).each(function(){
            var li_id = $(this).attr('id');
            var select_value = $('#'+elemid+' option#o'+li_id).attr('value');
             sortable_array = sortable_array+select_value+',';
           });
          sortable_array = sortable_array.split('undefined')[0];
          var sor_arr = sortable_array.substring(0,sortable_array.length-1);
          $("#"+hidden_id).attr('value',sor_arr);
         }
          });
        }
